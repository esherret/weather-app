    ...
    for window_name, hours in valid_windows.items():
      ...
      for h in hours:
        ...
        if h in day_hours:
          ...
          # Formatting: High/Low in white circles; Rising/Falling with bold arrows and unbolded text matching wind direction font size (9px)
          if tide_state == "High":
            ...
            tide_display = '<span style="font-weight: bold;">↗</span><span style="font-size: 9px; font-weight: normal;">Rising</span>'
          else:
            tide_display = '<span style="font-weight: bold;">↘</span><span style="font-size: 9px; font-weight: normal;">Falling</span>'
